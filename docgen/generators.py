from llms import OpenAIClient, SMALL_MODEL, MEDIUM_MODEL
...
def generate_directory_documentation(language: str, directory_path: str, file_descriptions: List[str])->str:
